...
class Chest(Enemy):
    def __init__(self, x, y):
        x_pos = 100+(x*64)
        y_pos = 90+(y*64)
        super().__init__("assets/images/chest_closed.png",  x_pos, y_pos, 3)

class Gravestone(Enemy):
    def __init__(self, x, y):
        x_pos = 100+(x*64)
        y_pos = 90+(y*64)
        super().__init__("assets/images/gravestone.png",  x_pos, y_pos, 3)
